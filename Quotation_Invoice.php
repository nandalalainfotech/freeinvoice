...
<head>
  ...
  <meta property="og:image" content="img/axAsset 8 (1).svg">
    ...
    <meta name="twitter:title" content="Quotation invoice">
              ...
              <div class="row">
                <div class="banner-text text-center">
                  <div class="text-border">
                    <h1 class="text-dec">QUOTATION INVOICE
                    </h1>
                  </div>
    ...
    <div class="row text1">
      ...
      <div class="row text1">
        <div class=" col-md-6 col-sm-12" >
          <p><img src="img/accept.webp" alt="right-symbol-4" width="20"> Invoice Number automatic generation of the Quotation invoice</p>
        </div>
        <div class="col-md-6 col-sm-12" >
