...
<head>
    ...
    <meta name="twitter:title" content="Teaching Invoice">
    <meta name="twitter:image" content="https://invoicefree.in/img/axAsset 8 (1).svg">
    <meta name="description" content="Generate professional teaching invoices easily with our free online tool.">
              ...
              <div class="row">
                <div class="banner-text text-center">
                  <div class="text-border">
                    <h1 class="text-dec">TEACHING INVOICE </h1>
                  </div>
