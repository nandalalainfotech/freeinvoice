...
<head>
    ...
    <meta name="twitter:title" content="Blank Invoice">
                    ...
                    <div class="row">
                        <div class="banner-text text-center">
                            <div class="text-border">
                                <h1 class="text-dec">BLANK INVOICE</h1>
                            </div>
                            <div class="intro-para text-center quote">
                                <p class="big-text"><span><img src="img/sheet.webp" alt="sheet" width="3%" class="car"></span>The blank invoice  provides a simple method to create professional invoices, ready for email or print. A standard invoice is a formal document itemizing purchased goods or services and the amount due.

                                </p>
                               
                                <a href="https://invoicefree.in/blank-invoice.html" class="btn get-quote"  target="_blank">Create Your Free Invoice</a>
                            </div>
