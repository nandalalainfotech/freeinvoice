...
<head>
    ...
    <meta name="twitter:title" content="GST Invoice">
                    ...
                    <div class="row">
                        <div class="banner-text text-center">
                            <div class="text-border">
                                <h1 class="text-dec">GST INVOICE </h1>
                            </div>
                            <div class="intro-para text-center quote">
                                <p class="big-text"><span><img src="img/Gst-icons.webp" alt="Gst-icons" width="5%" class="car">The invoice should clearly state any customs duty paid on the imported goods and the Integrated Goods and Services Tax (IGST) applicable on the import.

                                </p>
                               
                                <a href="https://invoicefree.in/gst-invoice.html" class="btn get-quote"  target="_blank">Create Your Free Invoice</a>
                            </div>
    ...
    <div class="container con">
        <div class="row m-3 p-3">
            <div class="col-md-6 col-xs-12">
                <img src="img/Image-GST-invoice.webp" class="img-thumbnail" alt="Image-GST-invoice">
            </div>
    ...
    <div class="container">
        <div class="gallery">
            <div class="images">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <img src="img/gst-invoice-templates(1).webp" alt="gst-invoice-templates(1)" class="img-thumbnail" loading="lazy">
                    </div>
                    <div class="col-md-4">
                        <img src="img/gst-invoice-templates(2).webp" alt="gst-invoice-templates(2)" class="img-thumbnail" loading="lazy">
                    </div>
                    <div class="col-md-4">
                        <img src="img/gst-invoice-templates(3).webp" alt="gst-invoice-templates(3)" class="img-thumbnail" loading="lazy">
                    </div>
                </div>
                <br>
                <!-- Second Row -->
                <div class="row">
                    <div class="col-md-4">
                        <img src="img/gst-invoice-templates(4).webp" alt="gst-invoice-templates(4)" class="img-thumbnail" loading="lazy">
                    </div>
                    <div class="col-md-4">
                        <img src="img/gst-invoice-templates(5).webp" alt="gst-invoice-templates(5)" class="img-thumbnail" loading="lazy">
                    </div>
                    <div class="col-md-4">
                        <img src="img/gst-invoice-templates(6).webp" alt="gst-invoice-templates(6)" class="img-thumbnail" loading="lazy">
                    </div>
                </div>
            </div>
      ...
      <section class="container">
        ...
        <div class="row text1">
          <div class=" col-md-6 col-sm-12" >
            <p><img src="img/accept.webp" alt="accept-4" width="20"> Invoice Number automatic generation of the GST Invoice</p>
          </div>
          <div class="col-md-6 col-sm-12" >
