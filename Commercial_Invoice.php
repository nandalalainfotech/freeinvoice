...
<head>
    ...
    <meta name="twitter:title" content="Commercial Invoice">
    <meta name="twitter:description" content="Generate and send professional commercial invoices online for free. Ideal for businesses of all sizes looking for efficient invoicing solutions.">
  ...
  <?php include('nav.php'); ?>
                    ...
                    <div class="row">
                        <div class="banner-text text-center">
                            <div class="text-border">
                                <h1 class="text-dec">COMMERICAL INVOICE </h1>
                            </div>
                            <div class="intro-para text-center quote">
                                <p class="big-text"><span><img src="img/invoice (3).webp" alt="invoice_icon" width="5%" class="car"></span> Commercial invoices, essential in international trade, detail goods
                                    sold, aiding customs clearance and regulatory compliance.
    ...
    <div class="container">
      ...
      <section class="container">
        <h3 style="text-align: center;">Key Features of Commerical Invoice </h3>
        <br>
        <div class="row text1">
