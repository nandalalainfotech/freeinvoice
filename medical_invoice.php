...
<head>
  ...
  <meta property="og:title" content="Medical invoice">
  <meta name="description" content="Create professional medical invoices with our free online invoice maker. Generate GST invoices and streamline your billing process.">
    <meta property="og:image" content="img/axAsset 8 (1).svg">
    <meta property="og:url" content="https://invoicefree.in">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Medical invoice">
              ...
              <div class="row">
                <div class="banner-text text-center">
                  <div class="text-border">
                    <h1 class="text-dec">Medical Invoice
                    </h1>
                  </div>
  ...
  <div class="row " >
    ...
    <div class="col-md-6 col-xs-12 text-center">
      ...
      <p style="text-align: justify;">A medical invoice is a document provided by healthcare providers to patients or their insurance companies
        ...
        medical expenses. </p>
       <button> <a href="https://invoicefree.in/medical-invoice.html" style="color: #FFFFFF; text-decoration: none; border-radius: 10px;" >Create Invoice </a></button>
